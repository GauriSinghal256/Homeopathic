              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+918447093878" className="hover:text-primary-600 transition-colors">
                        (+91) 08447 93878
                      </a>
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:drmadhav.homeoclinic@gmail.com" className="hover:text-primary-600 transition-colors">
                        drmadhav.homeoclinic@gmail.com
                      </a>
                    </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-300 rounded-xl h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mt-2">123 Health Street, Medical District, City 12345</p>
            </div>
          </div>
        </div>
      </section>
